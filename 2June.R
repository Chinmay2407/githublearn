## 1June was given off
##KNN - mostly used on Classification
##K nearest neighbour
## never reads full data set. only some part of data is read and predicts with that
...
library(class)
cl = factor(c(rep("setosa",5),rep("versicolor",5),rep("verginica",5)))
knn(trd,tsd,k=5,cl)
